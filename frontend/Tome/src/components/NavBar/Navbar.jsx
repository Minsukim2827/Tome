...
const Navbar = () => {
  ...
  <input
    type="search"
    placeholder="Search..."
    className="px-3 py-2 rounded-l-md cursor-text focus:outline-none text-white bg-gray-800 placeholder-white"
    style={{
      border: '1px solid transparent',
      borderImage: "linear-gradient(to right, white, #3b82f6) 1 stretch"
    }}
    value={searchQuery}
  ...
  <button
    type="submit"
    className="px-3 py-2 rounded-r-md text-white flex items-center justify-center"
    style={{
      background: 'transparent', // Set the background to transparent
      border: '1px solid transparent',
      borderImage: "linear-gradient(to left, white, #3b82f6) 1 stretch",
